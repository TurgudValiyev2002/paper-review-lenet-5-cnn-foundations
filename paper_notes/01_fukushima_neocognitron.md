...
![Neocognitron concept](../review_artifacts/neocognitron_concept.png)

The diagram shows the main idea: visual recognition moves from an input pattern to local features, then to pooling-like shift tolerance, then to higher-level features.
